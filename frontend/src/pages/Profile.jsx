...
import { changePassword, getProfileUser, updateUser } from "../api/user.api";
          ...
          {isSelectAccount ? (
            ...
            >
              ...
              <div className="flex items-center gap-5">
                <div className="p-2 text-[40px] font-bold bg-gray-300 rounded-full ">
                  <CgProfile />
                </div>
                <button className="flex gap-2 bg-sky-400 text-white p-2 rounded-2xl items-center transition duration-300 hover:bg-sky-600 cursor-pointer">
                  <div>
                    <BsUpload />
                  </div>
