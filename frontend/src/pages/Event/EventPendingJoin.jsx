...
const EventPendingJoin = () => {
  ...
  useEffect(() => {
    const fetchEvent = async () => {
      try {
        const res = await getEventByUserIdAndStatus("pending");
  ...
  return (
    <>
      <div>
        <h2 className="text-xl font-bold mb-4">Sự kiện đang chờ duyệt</h2>
...
export default EventPendingJoin;
